...
const LogoCarousel = () => {
  const logos = [
    "/colleges logos/MiamiUniversity.png",
    "/colleges logos/UNCG.png",
    "/colleges logos/Northeast.png",
    "/colleges logos/UNCcharlotte.png",
    "/colleges logos/SFCC.png",
    "/colleges logos/California.png",
    "/colleges logos/PENN.png",
    "/colleges logos/west-indies.png",
    "/colleges logos/Xavier.png",
    "/colleges logos/ACU.png",
    "/colleges logos/doane.png",
    "/colleges logos/Clemson.png",
    "/colleges logos/Regents.png",
    "/colleges logos/UNCpembroke.png",
